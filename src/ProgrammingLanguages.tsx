                ...
                <tr>
                    <td style={{ width: '50%', paddingRight:10 }}>
                        ...
                        <div className="skills-pill-container">
                            {['PyTorch/PyTorch Lightning', 'Jax/Flax', 'Tensorflow/Keras'].map((pill, i) => <span key={i} className="pill-span">{pill}</span>)}
                        </div>
                        ...
                        <p>
                            My favorite setup for deep learning currently is Jax+Flax, but PyTorch
                            + PyTorch-Lightning is the one I have most experience with.
                        </p>
                    </td>
                    <td style={{ width: '50%', paddingLeft:10 }}>
                        ...
                        <p>Computer graphics libraries which I use to display algorithms (hobby):</p>
                        <div className="skills-pill-container">
